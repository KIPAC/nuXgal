...
w_cross_2000 = hp_utils.vector_cross_correlate_maps(gg_density, syn_maps_2000, Defaults.NCL) / np.sqrt(cls_pdf_2000*cls_gg)
w_cross_10000 = hp_utils.vector_cross_correlate_maps(gg_density, syn_maps_10000, Defaults.NCL) / np.sqrt(cls_pdf_10000*cls_gg)
#w_cross_2000 = hp_utils.vector_cross_correlate_maps_normed(gg_density, syn_maps_2000, Defaults.NCL) 
#w_cross_10000 = hp_utils.vector_cross_correlate_maps_normed(gg_density, syn_maps_10000, Defaults.NCL) 

chi_2000 = w_cross_2000/w_cross_2000.std(0)
chi_10000 = w_cross_10000/w_cross_10000.std(0)
...
cl_data = [w_cross_2000.std(0), w_cross_10000.std(0), w_cross_2000.mean(0), w_cross_10000.mean(0)]
...
testfigfile = os.path.join(testfigpath, 'gal_cross_signal_reject')
